...
import 'package:magveto_web/base/helpers/clip_shadow_path.dart';
import 'package:magveto_web/base/helpers/cloud_clipper.dart';
  ...
  Widget build(BuildContext context) {
    return LayoutBuilder(
      builder: (ctx, constraints) {
        final maxWidth = type == CloudShapeType.wide ? min(constraints.maxWidth * 0.8, 700).toDouble() : min(constraints.maxWidth, 500).toDouble();
