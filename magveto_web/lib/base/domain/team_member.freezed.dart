...
abstract class $TeamMemberCopyWith<$Res> {
  ...
  @useResult
  $Res call({String name, String imagePath, String description});
}
...
class _$TeamMemberImpl implements _TeamMember {
  ...
  @override
  String toString() {
    return 'TeamMember(name: $name, imagePath: $imagePath, description: $description)';
  }
  ...
  @JsonKey(ignore: true)
  @override
  int get hashCode => Object.hash(runtimeType, name, imagePath, description);
...
abstract class _TeamMember implements TeamMember {
  const factory _TeamMember(
      ...
      required final String description}) = _$TeamMemberImpl;
