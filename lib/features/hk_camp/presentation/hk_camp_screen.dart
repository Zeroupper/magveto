...
import 'package:magveto/base/widgets/cloud_widget.dart';
...
import 'package:magveto/features/hk_camp/presentation/about_section.dart';
import 'package:magveto/features/hk_camp/presentation/features_section.dart';
import 'package:magveto/features/hk_camp/presentation/hk_reviews_section.dart';
...
class _HKCampScreenState extends State<HKCampScreen> {
  ...
  bool isFeedbackSectionVisible() {
    ...
    final RenderBox feedbackRenderBox =
        _feedbackSectionKey.currentContext!.findRenderObject() as RenderBox;
    final feedbackPosition =
        feedbackRenderBox.localToGlobal(const Offset(0, 0)).dy;
    return feedbackPosition - context.getScreenSize().height / 4 > 0 &&
        feedbackPosition - context.getScreenSize().height / 4 < 120;
  }
    ...
    return MagvetoScaffold(
      child: Listener(
        ...
        child: SingleChildScrollView(
          physics: _isFeedbackSectionActive
